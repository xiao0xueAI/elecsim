...
const QIACHIP = {
  ...
  templates: [
    // === 从元件库迁移过来的 QIACHIP 实物产品 ===
    // 433MHz 干接点继电器（保留原始 type，仿真引擎通过 type 识别）
    { id:'dry_relay', type:'dry_relay', name:'433MHz干接点继电器', model:'KR2201-COM',
      ...
      specs:{voltage:'AC 110V/220V',frequency:'433MHz',channels:1,relayRating:'10A'},
      ...
      behavior:'relay' },
    // 433MHz 1键遥控器
    { id:'rf_remote', type:'rf_remote', name:'433MHz 1键遥控器', model:'RF-1KEY',
      ...
      pins:[],
      specs:{frequency:'433MHz',channel:'A'},
      props:{freq:433,channel:'A',pressed:false},
      behavior:'remote' },
    // 433MHz 2键遥控器
    { id:'rf_remote_2key', type:'rf_remote_2key', name:'433MHz 2键遥控器', model:'RF-2KEY',
      ...
      signalImage:'images/rf_signal.webp',
      pins:[],
      specs:{frequency:'433MHz',channels:2},
